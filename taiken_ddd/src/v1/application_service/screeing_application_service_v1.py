...
class ScreeningApplicationServiceV1:
    ...
    def start_from_pre_interview(self, applicant_email_address: str) -> None:
        ...
        screening.status = ScreeningStatusV1.NotApplied  # 面談からの場合はステータス「未応募」で登録
    ...
    def apply(self, applicant_email_address: str) -> None:
        ...
        screening = ScreeningV1()
        screening.screening_id = str(uuid.uuid4())
        screening.status = ScreeningStatusV1.Interview
    ...
    def add_next_interview(self, screening_id: str, interview_date: datetime.date) -> None:
        ...
        screening: ScreeningV1 = self._screening_dao.find_screening_by_id(screening_id)
        ...
        interviews: List[InterviewV1] = self._interview_dao.find_by_screening_id(screening_id)

        interview = InterviewV1()
